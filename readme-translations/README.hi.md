...
- **एक साथ कनेक्शन:** फाइलों को एक साथ कई अंशों में डाउनलोड करके डाउनलोड गति को नाटकीय रूप से बढ़ाएं। **डाउनलोड सेटिंग्स → सामान्य → एक साथ कनेक्शन** में उपलब्ध है (डिफ़ॉल्ट 1 है, IP लिमिटिंग को रोकने के लिए अनुशंसित अधिकतम 8-10 है)।\n
</details>
