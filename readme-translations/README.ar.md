...
- **الاتصالات المتزامنة:** زيادة سرعة التنزيل بشكل كبير عن طريق تنزيل الملفات في أجزاء متعددة بشكل متزامن. متوفر في **إعدادات التنزيل → عام → الاتصالات المتزامنة** (الافتراضي هو 1، والحد الأقصى الموصى به هو 8-10 لمنع تقييد عنوان IP).\n
</details>
