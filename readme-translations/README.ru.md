...
- **Одновременные соединения:** Значительно увеличьте скорость загрузки, скачивая файлы в виде нескольких фрагментов одновременно. Доступно в **Настройки загрузки → Общие → Одновременные соединения** (По умолчанию 1, рекомендуемый максимум 8-10 для предотвращения блокировки IP).\n
</details>
